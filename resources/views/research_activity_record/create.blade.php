@extends('layouts.app')
@section('content')
    <h4 class="section-header">سوابق پژوهشی</h4>
    <section class="section-padding">
        <nav>
            <ol class="cd-breadcrumb triangle">
                ...
                <li class="current"><label>سوابق پژوهشی</label></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form method="post" action="{{route('research_activity_record.store')}}">
                    {{csrf_field()}}
                    <div class="row">
